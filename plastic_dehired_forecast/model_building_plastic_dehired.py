# -*- coding: utf-8 -*-
"""model_building_plastic_dehired.ipynb
...
data = pd.read_excel('/content/plastic_dehired_model.xlsx')
...
#data.to_excel('dataplastdehired.xlsx')
...
data = pd.read_excel('dataplastdehired.xlsx')
